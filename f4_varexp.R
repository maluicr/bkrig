...
# calculates experimental variogram from covid19 rates.
# only works in omnidirectional case,
# directional variograms not yet implemented.

# as input you should provide:

# an object list returned by funtion irates(), 
# lag distance and number of lags 
